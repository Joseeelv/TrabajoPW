<footer>
  ...
  <p><strong>Ubicación:</strong> Avenida Al-Andalus 12, San Fernando </p>
  <p><strong>Copyright:</strong> &copy; <?php echo date("Y"); ?> KEBAB SOCIETY Todos los derechos reservados</p>
